...
export interface ElastiCacheConfig extends TerraformModuleUserConfig {
  /**
...
export class ElastiCache extends TerraformModule {
  private readonly inputs: { [name: string]: any } = {};
  public constructor(scope: Construct, id: string, config: ElastiCacheConfig) {
    super(scope, id, {
      ...config,
  ...
  public get cloudwatchMetricAlarmsEnabled(): boolean | undefined {
    return this.inputs.cloudwatch_metric_alarms_enabled as boolean | undefined;
  }
